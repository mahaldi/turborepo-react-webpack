...
export class AppCounter extends React.Component {
    constructor(props) {
        ...
        this.globalStore.CreateStore("CounterApp", CounterReducer, []);
    ...
    updateState(globalState) {
        this.setState({
            ...
            globalCounter: globalState.CounterApp.globalCounter,
    ...
    render() {
        return (
            <div>
                <Counter count={this.state.globalCounter} header="Global Counter" increment={this.incrementGlobalCounter} decrement={this.decrementGlobalCounter}></Counter>
