export const CounterReducer = (state = initialState, action) => {
    if (action.type === "INCREMENT_GLOBAL") return { ...state, globalCounter: state.globalCounter + 1 };
    if (action.type === "DECREMENT_GLOBAL") return { ...state, globalCounter: state.globalCounter - 1 };
